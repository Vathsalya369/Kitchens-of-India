...
ALLOWED_HOSTS = ["*"]  # or you can restrict to Defang’s IP/domain later
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'foodieapp.context_processors.cart_counter',
            ],
        },
    },
]
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # conventional name for deployment
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
# EMAIL_HOST_USER = 'sugreevuvathsalya3@gmail.com'
# EMAIL_HOST_PASSWORD = 'vxsj vmky yskb sphm'
